...
const resellerBulletsEnd = [
  "Make Payoneer part of your registration flow ",
  ...
  "Feel free to share step-by-step sign-up guides ",
...
const partnerCards = [
  {
    ...
    bullets: [
      ...
      "Enable them to send and receive payments in 190+ countries and territories  ",
      ...
      "Seamless invoicing, reporting, and analytics ",
      "Full accounting sync with leading accounting and financial tools ",
      "Localized help in 17 languages to support your referrals ",
    ],
  },
  {
    image: transaction,
    ...
    bullets: [
      "Earn recurring revenue share on spent transaction volume generated by your referrals ",
      "We ofer a volume-tiered payouts- the more activity, the more you earn   ",
  ...
  },
  {
    ...
    link: "Build authority by promoting a trusted global payment platforms.   ",
    bullets: [
      "Access to co-marketing opportunities & shared promotional activities  ",
      "Gain a higher level of credibility by aligning with a global fintech leader  ",
      "Use Payoneer-branded banners, guides, and assets ",
...
const Programphases = [
  {
    ...
    desc: "To become an official Payoneer Affiliate .you will sign the ‘Payoneer marketing affiliate program terms and conditions’ and complete a quick onboarding process with your affiliate manager so you're fully set up to start referring clients. ",
  },
  {
    logo: affiliatephasesTwo,
    title: "Onboard & qualify your leads ",
    desc: "Introduce Payoneer to your audience and drive traffic through your affiliate links. You can give users a smooth start by sharing step-by-step guides for onboarding—covering verification, first payment, and account setup. While optional, this extra support helps turn interest into action and high-value leads. ",
  },
  {
          ...
          >
            ...
            <div className="max-w-6xl mx-auto mt-10 grid sm:grid-cols-3 gap-8 text-gray-800">
              ...
              <div className="p-6 bg-white rounded-2xl shadow-md border border-gray-200">
                ...
                <p className="mt-3">
                  Introduce to your clients a global payment solution that
                  enhances their entire package. Add real value, increase
                  retention, and elevate your brand.{" "}
                </p>
              </div>
              <div className="p-6 bg-white rounded-2xl shadow-md border border-gray-200">
                <div className="flex items-center gap-3">
              ...
              <div className="p-6 bg-white rounded-2xl shadow-md border border-gray-200">
                ...
                <p className="mt-3">
                  Get your customers up and running with Payoneer—completely
                  online. No paperwork, no delays, just quick and seamless
                  activation.
                </p>
              </div>
              <div className="p-6 bg-white rounded-2xl shadow-md border border-gray-200 sm:col-span-2">
                ...
                <ul className="list-disc list-inside mt-3 space-y-1">
                  ...
                  <li>Support in 117 languages </li>
                </ul>
