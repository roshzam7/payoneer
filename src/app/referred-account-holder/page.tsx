      ...
      <span>Download Page as PDF</span>
          ...
          <section id="kyc-process-explained" className="scroll-mt-28">
            ...
            <p className="mt-2 text-gray-900 text-[17px]">
                 As part of the onboarding process, you may be asked to provide additional documentation.
                  The following outlines the requirements, with clear guidance to help you prepare the information in
                   the correct format and avoid processing delays.
                </p>
...
You may be asked to provide evidence of your professional affiliation:                 </p>
